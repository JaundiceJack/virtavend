import { USER_LOGIN_REQUEST, USER_LOGIN_SUCCESS, USER_LOGIN_FAIL, USER_LOGOUT, USER_LOGIN_ERROR_RESET,
...
export const userEditReducer = (state = initialDelete, action) => {
  switch (action.type) {
