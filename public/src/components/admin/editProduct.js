...
const EditProduct = ({ opened, setOpened, selectedProduct }) => {
  ...
  const [category, setCategory] = useState(selectedProduct && selectedProduct.category);
  const [countInStock, setCountInStock] = useState(selectedProduct && selectedProduct.countInStock);
